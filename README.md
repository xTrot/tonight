...
- Throughout the entire project and all of the sprints including this one, the one constant thing that has worked out well for us was to keep everything simple. In this last sprint we realized that we had to keep things even simpler from before and focus on the functionality of our code instead of the visual appearance of our application. One of the best things that worked for us were the functions that were being implemented inside the database that simplified and made our process faster by providing us a simple alternative to otherwise tedious and repetitive codes. This gave the team the ability to distribute tasks more efficiently to reach completion. We also recognize that our individual understanding was one of the most important aspects that worked well for this sprint. We found that this aspect helped reduce our workload by reducing the amount of mistakes made when linking the server side and client side through the queries. Overall, we feel that our group dynamic was a key factor in our steady completion of this project and the aspect that worked best for us. As a team of three people, we had each person take on a different and important role in the project. Each of us was tasked with either server side coding, client side coding, or creating code that linked these two sides together. We found that it was the most efficient and logical way to proceed with this project and it proved to be the most motivating aspect of our process.

2. What didn't worked well? 

- In this sprint it became apparent how important it was to pass parameters from one view of the application to another. We found this to be the most difficult obstacle as no one in the team had a clear understanding of how Angular could be used to pass these parameters and, more than once, we found ourself stopping the process altogether to solve this one problem that would appear repeatedly throughout the final phase. Even though we were able to superfically solve the problem, we realized that the obstacle itself was much larger than it originally seemed when we encountered the problem of trying to pass these URL string parameters to our router page that handled all the queries in an attempt to identify each entity with their respective id to obtain, use, and display the correct attributes. This was the constant factor that made completion of this project seem impossible since our project itself could not be considered a running program if it couldn't do something as simple as navigating and showing the correct information on the requested pages. Although we were able to get over this hurdle, it proved to have taken a lot of our time that could have been focused on more important issues throughout the project. Another aspect that did not work too well for us was our attempt to keep our views from changing. Our initial designs of the views made our code be more difficult than what it needed to be and we found ourself spending too much time trying to get certain pages to look like their design instead of focusing on the functionality at the start of this phase. 
 
3. What we learned? 

- This sprint proved to be one of, if not the most, important learning experience that we've had throughout the course. This sprint is where our team focused solely on linking the client side and server side together as best and functionally efficient as possible. Each one of us started entering into different roles to understand and help each other when one of us got stuck on a certain problem. This helped us spread each person's unique knowldege across the team to better understand how all the different parts of the system came together to be our program. We learned how difficult it is to try and have everything done on time, how stressing and frustrating it is when a certain part of your code does not work the way you want it to, and, most importantly, we learned how to get over each and everyone of those problems to further advance the completion of this code in the small amount of time given to us. Overall, we learned how to work in a team where each person is only tasked with one specific role of the project and how to bring it all together in the end, how to expand our knowldege and understanding on engineering problems such as choosing the best alternative between two different ways of making the same page, how important it is to schedule work time and keep to the schedule, and how important it is to keep an open mind when listening to each other's opinion to make sure everyone is on the same track. These experiences will surely prove useful for future endeavors. 